    ...
    <div className="space-y-5 animate-fade-in">
      ...
      <div className="glass rounded-2xl overflow-hidden">
        <div className="px-5 py-3.5 border-b border-gray-100 flex items-center justify-between">
          ...
          {search && (
            <button onClick={() => setSearch('')} className="text-xs text-gray-500 hover:text-gray-900 flex items-center gap-1">
                    ...
                    <Fragment key={msg._id}>
                      <tr key={msg._id} className="hover:bg-gray-50 transition-colors">
                        <td className="px-5 py-4">
                          ...
                          <p className="text-gray-500 text-xs mt-0.5">{days} day rental</p>
                        </td>
                        <td className="px-5 py-4">
                        ...
                        <td className="px-5 py-4">
                          <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-gray-700">{vehicleLabels[msg.vehicleType] || msg.vehicleType}</span>
                          </div>
                        </td>
                        <td className="px-5 py-4">
                          <div className="space-y-1">
                                ...
                                {confirmDelete === msg._id ? (
                                  <div className="flex items-center gap-1">
                                    ...
                                    <button
                                      ...
                                      className="px-2 py-1 text-xs bg-red-50 text-red-600 border border-red-200 rounded-lg hover:bg-red-100 transition-colors"
                                    >Yes</button>
                                    <button
                      ...
                      {expandedId === msg._id && msg.message && (
                        <tr key={`${msg._id}-exp`} className="bg-gray-50">
